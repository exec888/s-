				...
				local function onActivate()
					...
					if (Toggle) then			
						...
						if Table.Key then
							...
							if config.Save then writefile(config.ConfigFolder.."/"..Table.Key..".txt", "true")--[[Sync(1, {Table.Key..".txt", "false"})]] end
						end
					...
					elseif not (Toggle) then
						...
						if Table.Key then
							Keys[Table.Key].Value = Toggle
							if config.Save then writefile(config.ConfigFolder.."/"..Table.Key..".txt", "false")--[[Sync(1, {Table.Key..".txt", "true"})]] end
						end
